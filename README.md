...
| 授权类型 | 定价 | 授权期限 | 适用场景 | 说明 |
|---------|------|---------|---------|------|
| **散单授权** | 299元/台 | 永久授权 | 个人客户、小批量采购 | 软件使用权，不含技术服务 |
| **批量授权** | 199元/台（10台起） | 永久授权 | 网关工厂、集成商批量预装 | 软件使用权，不含技术服务 |
| **企业定制** | 按需报价 | 永久授权 | 定制开发、专属支持 | 含定制开发 + 技术服务 |

### 为什么选择 sfsEdgeStore？

| 优势 | 说明 |
|-----|------|
| **性能领先** | ~30MB 内存，4000条/秒写入，远超同类产品 |
| **官方适配** | sfsDb 官方团队打造，质量保障 |
| **EdgeX 原生** | 专为 EdgeX 设计，开箱即用 |

对比：国产通用边缘网关 ¥600-1200/台，而 sfsEdgeStore 只要 ¥199-299，就能获得更好的性能！

...
func TestEncryptionBasic(t *testing.T) {
	...
	// 创建加密存储
	encryptedStore, err := NewLevelDBStoreWithEncryption("./test_encrypted_db", encryptConfig)
	if err != nil {
...
func TestEncryptionBatch(t *testing.T) {
	...
	// 创建加密存储
	encryptedStore, err := NewLevelDBStoreWithEncryption("./test_encrypted_batch_db", encryptConfig)
	if err != nil {
		t.Fatalf("Failed to create encrypted store: %v", err)
	}
	defer encryptedStore.Close()
...
func TestEncryptionIterator(t *testing.T) {
	...
	// 创建加密存储
	encryptedStore, err := NewLevelDBStoreWithEncryption("./test_encrypted_iterator_db", encryptConfig)
	if err != nil {
		t.Fatalf("Failed to create encrypted store: %v", err)
	}
	defer encryptedStore.Close()
...
func TestEncryptionSnapshot(t *testing.T) {
	...
	// 创建加密存储
	encryptedStore, err := NewLevelDBStoreWithEncryption("./test_encrypted_snapshot_db", encryptConfig)
	if err != nil {
		t.Fatalf("Failed to create encrypted store: %v", err)
	}
	defer encryptedStore.Close()
...
func TestEncryptionReEncrypt(t *testing.T) {
	...
	// 创建加密存储
	encryptedStore, err := NewLevelDBStoreWithEncryption("./test_encrypted_reencrypt_db", oldEncryptConfig)
	if err != nil {
		t.Fatalf("Failed to create encrypted store: %v", err)
	}
	defer encryptedStore.Close()
...
func TestEncryptionWithPassword(t *testing.T) {
	...
	// 创建加密存储
	encryptedStore, err := NewLevelDBStoreWithEncryption("./test_encrypted_password_db", encryptConfig)
	if err != nil {
...
func TestEncryptionDisabled(t *testing.T) {
	...
	store, err := NewLevelDBStoreWithEncryption("./test_encrypted_disabled_db", encryptConfig)
	if err != nil {
